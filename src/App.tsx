...
export default function BlackTarLanding() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-mono">
      ...
      <section className="relative pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6 min-h-screen">
        <div className="max-w-7xl mx-auto h-full">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center h-full">
            <div className="z-10">
              <div className="inline-block px-3 py-1 bg-zinc-900 border border-zinc-800 text-xs tracking-wider mb-4 md:mb-6">
              ...
              <button className="w-full sm:w-auto px-8 py-4 bg-zinc-100 text-zinc-950 font-bold hover:bg-zinc-300 transition-colors flex items-center justify-center gap-2 group">
                GET STARTED
                <ArrowRight
      ...
      {/* Services Section */}
      <section id="services" className="py-12 md:py-20 px-4 md:px-6 bg-zinc-900/50">
      ...
      <section id="about" className="py-12 md:py-20 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6">BUILT ON EXCELLENCE</h2>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-zinc-900 border border-zinc-800 p-4 md:p-6 text-center"
                >
                  <div className="text-2xl md:text-3xl font-bold mb-1 md:mb-2">{stat.num}</div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 md:py-20 px-4 md:px-6 bg-zinc-900/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6">LET'S BUILD SOMETHING</h2>
          ...
          <button className="w-full sm:w-auto px-12 py-4 bg-zinc-100 text-zinc-950 font-bold hover:bg-zinc-300 transition-colors text-base md:text-lg">
            CONTACT US
          </button>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-800 py-6 md:py-8 px-4 md:px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-zinc-600">
